...
class EditYourItinForm extends Component {
  constructor(props) {
    super(props);
    this.state = { id: this.props.match.params.id,  name: "", city: "", departure_date: Number, date_returning:"", budget:"" };
  ...
  render() {
    return (
      <form onSubmit={this.submitHandler}>
        ...
        <label>date_departing
          <input onChange={this.changeHandler} type="text" name="departure date" />
        </label>
        <label>date_returning
